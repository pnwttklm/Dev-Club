...
export default function Header() {
    return (
      ...
      <div>
                ...
                <Link href="https://forms.gle/WEeVVa5fKjRgTQ2dA" className="bg-[#000000] text-white text-2xl hover:text-black hover:bg-[#FFFFFF] border-2 border-black mr-6 hover:italic py-4 px-16  mt-6"><h1>Submit Your Application</h1></Link>
            </div>
            <div>
