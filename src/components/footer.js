...
<h1 className="text-right">
  Copyright © {year}. Dev Club,<br/>in association with Faculty of Information and Communication Technology, Mahidol University. All rights reserved.<br/>Version 1.1.0</h1>
          </div>
        </div>
        </div>
  );
